...
P38_OUTPUT_ROOT = Path(os.getenv("P38_OUTPUT_ROOT", str(P38_PROJECT_ROOT / "p38_publication_outputs")))
P38_UPSTREAM_ROOT = Path(os.getenv("P38_UPSTREAM_ROOT", "/data3/Group8/gonglihao/20250507p38-up"))
P38_THREADS = int(os.getenv("NSLOTS", os.getenv("P38_WORKERS", os.getenv("P38_THREADS", "4"))))
...
def upstream_path(*parts: str) -> str:
    return str(P38_UPSTREAM_ROOT.joinpath(*parts))

def legacy_path(*parts: str) -> str:
    return p38_path(*parts)
