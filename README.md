...
|---|---|---|---|
| `01`-`07` | QC, integration, annotation and marker validation | R `42` | R 4.4.2; Seurat 5.1.0; SeuratObject 5.0.2; Harmony 1.2.3 |
| `08a` | Export the final trajectory Seurat object | R `42` | R 4.4.2; Seurat 5.1.0 |
...
| `11`-`15`, `17`-`18` | Differential expression, enrichment and R-based manuscript panels | R `42` | R 4.4.2; monocle3 1.3.1; clusterProfiler 4.14.6; GseaVis 0.1.1 |
